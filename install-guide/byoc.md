...
| [Nephio in Docker](nind.md) | Similar to the demo sandbox environment but in a Docker container. This creates a complete Nephio-in-Docker, just like the R1 demo sandbox. These instructions cover both the manual installation but also an automated installation script. |
